...
// Organic design system — tokens from the Claude Design handoff.
// https://fonts... styles.css is the source of truth; values copied exactly, not rounded.
...
val ColorDivider = Color(0x29201E1D) // #201e1d at 16%
